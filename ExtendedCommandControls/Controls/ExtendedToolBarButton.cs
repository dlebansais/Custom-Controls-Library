...
public partial class ExtendedToolBarButton : Button
{
    ...
    /// </summary>
    private static void OverrideMetadataDefaultStyleKey() => DefaultStyleKeyProperty.OverrideMetadata(typeof(ExtendedToolBarButton), new FrameworkPropertyMetadata(typeof(ExtendedToolBarButton)));
    ...
    /// </summary>
    private static void OverrideMetadataCommandKey() => CommandProperty.OverrideMetadata(typeof(ExtendedToolBarButton), new FrameworkPropertyMetadata(OnCommandChanged));
    ...
    /// </summary>
    private void OnCommandChanged() => UpdateVisibility();
    #endregion
    ...
    /// </summary>
    public virtual void ResetIsActive() => IsActive = IsDefaultActive;
    #endregion
    ...
    /// </summary>
    private void InitializeIsActive() => IsActive = IsDefaultActive;
